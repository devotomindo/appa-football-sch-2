...
export type GetAllCoachesBySchoolIdResponse = Awaited<
  ReturnType<typeof getAllCoachesBySchoolId>
>;

export const getAllCoachesBySchoolId = cache(async function (schoolId: string) {
